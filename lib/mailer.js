...
// The board is asked by email, on WhatsApp and on LINE, so the links live in
// lib/links and are re-exported here for everything that already asks the
// mailer for them. There is one vote URL, built in one place.
const { siteUrl, voteUrl } = links;
