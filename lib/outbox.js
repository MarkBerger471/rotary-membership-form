...
// takes one tap.
function textFor({ kind, app, recipient, channel, closeDays, daysLeft, result, tally, template }) {
  ...
  CHANNELS.forEach(channel => {
    board.on(recipients, channel).forEach(r => {
      ...
      entries.push({
        ...
        text: textFor({ kind, app, recipient: r, channel, closeDays, daysLeft, result, tally, template }),
