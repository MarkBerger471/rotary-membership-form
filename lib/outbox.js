...
// of them.
async function queueNote({ channel, key, name, lineName, waNumber, text, about }) {
  ...
  if (waiting) {
    Object.assign(waiting, { text: entry.text, name: entry.name, lineName: entry.lineName, waNumber: entry.waNumber, queuedAt: entry.queuedAt });
